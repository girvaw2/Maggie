...
public:
  ...
  head_tracking () : cloud_topic_("/camera/depth_registered/points"),image_topic_("output")
  {
    sub_ = nh_.subscribe (cloud_topic_, 30,&head_tracking::cloud_cb, this);
...
{
  ros::init (argc, argv, "track a head");
  head_tracking ht; //this loads up the node
